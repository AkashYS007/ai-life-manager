...
// included, not just wherever Nest happens to resolve first. AiUsageModule
// added by the AI cost telemetry increment.
@Module({
  imports: [UsersModule, PlannerModule, AiUsageModule],
